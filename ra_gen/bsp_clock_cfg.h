...
#define BSP_CFG_CECCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_SUBCLOCK) /* CECCLK Src: SUBCLK */
...
#define BSP_CFG_USB60CLK_DIV (BSP_CLOCKS_USB60_CLOCK_DIV_4) /* USB60CLK Div /4 */
