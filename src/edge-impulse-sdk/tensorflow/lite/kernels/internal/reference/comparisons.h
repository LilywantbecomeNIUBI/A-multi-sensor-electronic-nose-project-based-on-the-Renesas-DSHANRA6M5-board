...
TFLITE_COMPARISON_OP(Equal); // @suppress("Function cannot be instantiated") // @suppress("Invalid overload")
TFLITE_COMPARISON_OP(NotEqual); // @suppress("Function cannot be instantiated") // @suppress("Invalid overload")
TFLITE_COMPARISON_OP(Greater); // @suppress("Function cannot be instantiated") // @suppress("Invalid overload")
TFLITE_COMPARISON_OP(GreaterEqual); // @suppress("Function cannot be instantiated") // @suppress("Invalid overload")
TFLITE_COMPARISON_OP(Less); // @suppress("Function cannot be instantiated") // @suppress("Invalid overload")
TFLITE_COMPARISON_OP(LessEqual); // @suppress("Function cannot be instantiated") // @suppress("Invalid overload")
