...
CPP_SRCS += \
../src/edge-impulse-sdk/porting/synaptics/debug_log.cpp \
../src/edge-impulse-sdk/porting/synaptics/ei_classifier_porting.cpp 

CREF += \
demoElectronicNoseAllSensor5.3.cref 

OBJS += \
./src/edge-impulse-sdk/porting/synaptics/debug_log.o \
./src/edge-impulse-sdk/porting/synaptics/ei_classifier_porting.o 

MAP += \
demoElectronicNoseAllSensor5.3.map 

CPP_DEPS += \
./src/edge-impulse-sdk/porting/synaptics/debug_log.d \
./src/edge-impulse-sdk/porting/synaptics/ei_classifier_porting.d 


# Each subdirectory must supply rules for building sources it contributes
src/edge-impulse-sdk/porting/synaptics/%.o: ../src/edge-impulse-sdk/porting/synaptics/%.cpp
	@echo 'Building file: $<'
