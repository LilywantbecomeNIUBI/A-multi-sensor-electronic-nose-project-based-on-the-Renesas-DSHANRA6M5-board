...
CPP_SRCS += \
../src/edge-impulse-sdk/porting/mbed/debug_log.cpp \
../src/edge-impulse-sdk/porting/mbed/ei_classifier_porting.cpp 

CREF += \
demoElectronicNoseAllSensor5.3.cref 

OBJS += \
./src/edge-impulse-sdk/porting/mbed/debug_log.o \
./src/edge-impulse-sdk/porting/mbed/ei_classifier_porting.o 

MAP += \
demoElectronicNoseAllSensor5.3.map 

CPP_DEPS += \
./src/edge-impulse-sdk/porting/mbed/debug_log.d \
./src/edge-impulse-sdk/porting/mbed/ei_classifier_porting.d 


# Each subdirectory must supply rules for building sources it contributes
src/edge-impulse-sdk/porting/mbed/%.o: ../src/edge-impulse-sdk/porting/mbed/%.cpp
	@echo 'Building file: $<'
