...
CPP_SRCS += \
../src/edge-impulse-sdk/porting/himax/debug_log.cpp \
../src/edge-impulse-sdk/porting/himax/ei_classifier_porting.cpp 

CREF += \
demoElectronicNoseAllSensor4.1.cref 

OBJS += \
./src/edge-impulse-sdk/porting/himax/debug_log.o \
./src/edge-impulse-sdk/porting/himax/ei_classifier_porting.o 

MAP += \
demoElectronicNoseAllSensor4.1.map 

CPP_DEPS += \
./src/edge-impulse-sdk/porting/himax/debug_log.d \
./src/edge-impulse-sdk/porting/himax/ei_classifier_porting.d 


# Each subdirectory must supply rules for building sources it contributes
src/edge-impulse-sdk/porting/himax/%.o: ../src/edge-impulse-sdk/porting/himax/%.cpp
	@echo 'Building file: $<'
