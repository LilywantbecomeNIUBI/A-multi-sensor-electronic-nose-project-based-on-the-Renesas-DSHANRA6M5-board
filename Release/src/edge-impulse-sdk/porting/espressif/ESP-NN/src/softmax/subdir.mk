...
C_SRCS += \
../src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/esp_nn_softmax_ansi.c \
../src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/esp_nn_softmax_opt.c 

CREF += \
demoElectronicNoseAllSensor4.1.cref 

C_DEPS += \
./src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/esp_nn_softmax_ansi.d \
./src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/esp_nn_softmax_opt.d 

OBJS += \
./src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/esp_nn_softmax_ansi.o \
./src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/esp_nn_softmax_opt.o 
...
src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/%.o: ../src/edge-impulse-sdk/porting/espressif/ESP-NN/src/softmax/%.c
	@echo 'Building file: $<'
