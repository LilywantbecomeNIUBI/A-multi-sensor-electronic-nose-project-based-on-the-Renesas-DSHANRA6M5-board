...
CC_SRCS += \
../src/edge-impulse-sdk/tensorflow/lite/kernels/custom/tree_ensemble_classifier.cc 

CREF += \
demoElectronicNoseAllSensor4.1.cref 

CC_DEPS += \
./src/edge-impulse-sdk/tensorflow/lite/kernels/custom/tree_ensemble_classifier.d 
...
src/edge-impulse-sdk/tensorflow/lite/kernels/custom/%.o: ../src/edge-impulse-sdk/tensorflow/lite/kernels/custom/%.cc
	@echo 'Building file: $<'
