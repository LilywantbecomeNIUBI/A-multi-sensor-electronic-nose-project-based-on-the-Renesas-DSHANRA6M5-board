...
CC_SRCS += \
../src/edge-impulse-sdk/tensorflow/lite/kernels/kernel_util_lite.cc 

CREF += \
demoElectronicNoseAllSensor4.1.cref 

CC_DEPS += \
./src/edge-impulse-sdk/tensorflow/lite/kernels/kernel_util_lite.d 
...
src/edge-impulse-sdk/tensorflow/lite/kernels/%.o: ../src/edge-impulse-sdk/tensorflow/lite/kernels/%.cc
	@echo 'Building file: $<'
